<template>
  ...
  >
    <div class="overlap-box">
      <div class="square square-lg piece small red" v-if="!this.board.state[this.board.currentKey][x][y].selected"></div>
    ...
    <div class="overlap-box">
      <div class="square square-lg piece small blue" v-if="!this.board.state[this.board.currentKey][x][y].selected"></div>
      <div class="square square-lg piece small selected" v-else></div>
    </div>
    <div class="overlap-box">
      <div>
  ...
  <div
    ...
    v-else-if="this.board.state[this.board.currentKey][x][y].stack.blue == 0 && this.board.state[this.board.currentKey][x][y].stack.red != 0"
    @click.stop="this.board.selectPiece(x, y)"
  ></div>
  <div
