...
#### Authentication
To use the application, you need to authenticate. The authentication page is the first thing you'll see when opening the game. There are two types of users: *Player* and *Admin*. The *Player* type is for students, and the *Admin* type is for teachers. Both use the same aforementioned page. The default credentials are:
- *Player*:
    - username: student
    - password: password
- *Admin*:
...
When you think you've hit the code coverage objective, you can click the "Go" button. This will check if you've hit the objective. If you have, the left side of the Challenge page will show you a green callout, telling you you've passed the challenge. Othwerwise, a red callout will appear prompting you to try again.
