<template>
    ...
    <div class="row" style="justify-content: center; display: flex; flex-direction: row;">
      <div class="col">
        ...
        <div class="row" style="width: 100%; margin-left: 0px; margin-bottom: 10px;">
          <select class="button is-primary guide-button" id="code-file-select" style="width: 650px;" :value="this.challenge?.code_file">
  ...
  <div class="container" style="display: flex; justify-content: center; flex-direction: column;">
    ...
    <div class="row" style="margin-bottom: 10px;">
      ...
      <div class="col">
        <div class="alert alert-secondary player-info" style="display: flex; flex-direction: column; width: 100%; font-size: 12px;">
          <p style="display: inline-block; flex-direction: row; margin: 0px; margin-bottom: 2.5px;" v-if="this.codeFiles[this.challenge.code_file - 1] != undefined"><em>(I, J)</em> can be any position!</p>
          ...
          <p v-else class="row" style="display: inline-block; flex-direction: row; margin: 0px; margin-bottom: 2.5px;"
            ...
            <strong style="padding-right: 0px;">{{ key + ': ' }}</strong>{{ value.accessing }}
          </p>
        </div>
      </div>
