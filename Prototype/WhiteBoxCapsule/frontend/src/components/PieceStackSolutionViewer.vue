<template>
  <div v-if="this.solution.state[this.solution.currentKey] != undefined">
    <div class="col piece-overlap"
      v-if="(this.solution.state[this.solution.currentKey] == undefined ? [].length :
      this.solution.state[this.solution.currentKey][x][y].pieceCount()) > 1"
      >
      <div class="overlap-box">
        <div class="square square-lg piece small red"
          v-if="!this.solution.state[this.solution.currentKey][x][y].selected"></div>
    ...
    <div class="square square-lg piece selected"
      ...
      <font-awesome-icon v-if="this.solution.state[this.solution.currentKey][x][y].king" icon="crown" fixed-width
        style="color: white;" />
    </div>
