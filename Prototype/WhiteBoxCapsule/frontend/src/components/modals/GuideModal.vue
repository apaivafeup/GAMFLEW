    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content" style="padding: 0px 20px; border-radius: 50px;">
        ...
        <div class="modal-body">
          <div v-if="tab == 'board'" style="font-size: 12px !important;">
            <div class="row" style="justify-content: space-between;">
              <div class="col" style="margin-bottom: 10px; margin-right: 7.5px; border: #ccc 1px solid; padding: 10px;">
                <h6>Test Cases</h6>
                <p style="text-align: justify; margin: 0px;">
                  When you click the <button class="button is-primary is-fullwidth">
                    Previous
                  </button> and <button class="button is-primary is-fullwidth">
                    Next
                  </button> buttons, you cycle through different boards - for each challenge, you get as many as you need. <br style="margin-bottom: 5px;" />
                  When all your test cases are done, click the <button class="button is-primary is-fullwidth">
                    Submit
                  </button> button to check your answer. <br style="margin-bottom: 5px;" />
                  After this, you have to click the <button class="button is-primary is-fullwidth">
                    Comment
                  </button> button and explain your solution - it's required for your attempt to be submitted! And anonymous to other players. <br /> 
                </p>
              </div>


              <div class="col" style="margin-bottom: 10px; margin-left: 7.5px; border: #ccc 1px solid; padding: 10px;">
                <h6>Interacting with the Board</h6>
                <p style="text-align: justify; margin: 0px;">
                  The boards have boxes where pieces can be placed. See below the possible states.</p>
                <div class="row" style="display: flex; justify-content: center; margin: 5px 0px 5px 0px;">
                  <div class="box" id="board-box-example-red" style="width: 55px; height: 55px;">
                  </div>

                  <div class="box" id="board-box-example-red" style="width: 55px; height: 55px; padding: 0px;">
                    <div class="square square-lg small red"
                      style="height: 45px; width: 45px; border-radius: 100px; border: 1px solid var(--border-color);">
                    </div>
                  </div>
                ...
                <div class="row" style="display: flex; justify-content: center; margin: 5px 0px 5px 0px;">
                  <div class="box" id="board-box-example-selected" style="width: 55px; height: 55px; padding: 0px;">
            ...
            <div class="row" style="border: #ccc 1px solid; padding: 10px;"> 
              ...
              <p style="text-align: justify; margin: 0px;">
                ...
                Each click gives you one of three states: red, blue, empty (in that order). <br /></p>
              <div class="row" style="display: flex; justify-content: center;">
                <img src="../../assets/pictures/add_piece.gif" alt="add-piece"
                  style="width: 80px; margin: 5px 0px 5px 0px;" />
              </div>
              <p style="text-align: justify; margin: 0px;">
                You can add as many pieces as you want, but you can't add pieces to a stack with this feature.
                You can, however, remove the stack altogether (turn it into an empty spot) and then add individual pieces.
                Click the <button class="button is-primary is-fullwidth">
                  Add
                </button> button again to stop adding pieces.
              </p>
            </div>
          </div>
          <div v-if="tab == 'auxiliary_functions'" style="font-size: 13px !important;">
            ...
            <div class="row" style="padding: 10px;">
              <button :class="name == 'isTriangle' ? 'col button is-primary is-fullwidth guide-button guide-button-selected' : 'col button is-primary is-fullwidth guide-button'" :id="'guide-button-'+name" v-for="name in auxiliaryFunctionsNames"
        ...
        <div class="modal-footer row" style="padding: 10px 20px;">
          <button id="guide-button-1" class="col button is-primary is-fullwidth guide-button guide-button-selected" @click="changeTab('board', '1')">
            Board
          </button>
          <button id="guide-button-2" class="col button is-primary is-fullwidth guide-button" @click="changeTab('auxiliary_functions', '2')">
            Auxiliary Functions
          </button>
        </div>
      </div>
